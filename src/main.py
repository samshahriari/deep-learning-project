...
if __name__ == "__main__":
    ...
    training_process = Training(model, 0.001, False, model_info['num_epochs'], training_dataset, validation_dataset, test_dataset, model_info)
    ...
    #     training_process = Training(model, model_info['learning_rate'], False, model_info['num_epochs'], training_dataset, validation_dataset, test_dataset, model_info)
    #     training_process.train()
